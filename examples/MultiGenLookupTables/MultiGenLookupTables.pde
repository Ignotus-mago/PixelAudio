// PLACEHOLDER FOR VISUALIZATION OF MULTIGENs
...
int imageWidth = 1536;     // for Moore and Hilbert curves, use equal powers of 2
int imageHeight = 1024;    // for imageWidth and imageHeight
int genW = 8;              // the width of generator: must be a power of 2 for Hilbert and Moore, 4 and 8
                           // are good, 1024 is the max
int genH = 8;              // the height of generator: must be a power of 2 for Hilbert and Moore, 4 and 8
                           // are good, 1024 is the max
...
public void initGens() {
    ...
    bGen = new BoustropheGen(genW, genH, AffineTransformType.ROT90);
}
