 ...
 * visits in the order it visits them. The pixel locations are indices for a
 * pixel array, which starts at (0,0) in the upper left corner of a bitmap, and
 * proceeds left to right, top to bottom. The bitmap has a corresponding lookup
 * table, where the array indices of the audio signal are stored. The lookup
 * tables may be generated by mathematical functions, such as the Hilbert curve,
 * but they only need to be calculated once. PixelAudio classes that implement
...
int genW = 4;              // the width of generator: must be a power of 2 for Hilbert and Moore curves,
                           // 4 is the minimum and probably is best for your MultiGens, but 8 might be worth a try.
 ...
 * one approach to mixing different PixelMapGens in a MultiGen. We use "gen" as an
 * abbreviated name for a PixelMapGen.
 *
 * @param genW
 * @param genH
 * @return
...
public MultiGen hilbertZigzagLoop6x4(int genW, int genH) {
  // list of gens that create a path through an image using PixelAudioMapper
  ArrayList<PixelMapGen> genList = new ArrayList<PixelMapGen>();
  // list of x,y coordinates for placing gens from genList
  ArrayList<int[]> offsetList = new ArrayList<int[]>();
  // array of grid locations for each gen
  int[][] locs = {{0, 0}, {0, 1}, {0, 2}, {0, 3}, {1, 3}, {1, 2}, {2, 2}, {2, 3},
    {3, 3}, {3, 2}, {4, 2}, {4, 3}, {5, 3}, {5, 2}, {5, 1}, {5, 0},
    {4, 0}, {4, 1}, {3, 1}, {3, 0}, {2, 0}, {2, 1}, {1, 1}, {1, 0}};
  // array of the transforms applied to each gen
  ...
  // array of characters that flag the type of each gen
...
public void keyPressed() {
  ...
  case 'w':
    ...
    // resizing is easy when you draw to an offscreen image and resize it to the display
...
/**
 * Draw the numbers for image path and signal path.
 */
