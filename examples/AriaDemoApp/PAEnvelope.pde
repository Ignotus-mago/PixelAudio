...
public class PAEnvelope {
  ...
  /**
   * In Processing, this factory method can't be declared static, since classes declared in 
   * Procssing are all treated as interior classes of the main PApplet. 
   *
   * @param maxAmplitude
   * @param attackTime
   * @param decayTime
   ...
   * @param releaseTime
   */
  private PAEnvelope(float maxAmplitude, float attackTime, float decayTime, float sustainLevel, float releaseTime) {
