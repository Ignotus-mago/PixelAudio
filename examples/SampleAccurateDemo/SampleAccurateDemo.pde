...
final int DISPLAY_W = 1536;
final int DISPLAY_H = 1024;
final int GEN_W = 512;
final int GEN_H = 512;
...
final int BEAT_COUNT = 128;
final float DEFAULT_SAMPLER_INTERVAL_MS = 117.0f;
final float DEFAULT_GRANULAR_INTERVAL_MS = 117.0f;
final long SCHEDULE_LEAD_SAMPLES = 2048L;
final float BEAT_BRUSH_SIZE = 18.0f;

final String DEFAULT_AUDIO_PATH = "../examples_data/Bag/bag_1_newSpiral.wav";
final String WORKSPACE_AUDIO_PATH = "examples/examples_data/Bag/bag_1_newSpiral.wav";
final String DIST_AUDIO_PATH = "distribution/PixelAudio-1/examples/examples_data/Bag/bag_1_newSpiral.wav";
...
File resolveDefaultAudioFile() {
    ...
    File workspace = new File(WORKSPACE_AUDIO_PATH);
    if (workspace.isFile()) return workspace;
