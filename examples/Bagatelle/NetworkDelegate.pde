...
public class NetworkDelegate {
  ...
  public NetworkDelegate(Bagatelle app, String remoteFromAddr, String remoteToAddr, int inPort, int outPort) {
    this.app = app;
  ...
  public NetworkDelegate(Bagatelle app, String remoteFromAddr, String remoteToAddr) {
    this.app = app;
    this.parent = app.getPApplet();
    this.osc = new OscP5(parent, inPort);
    this.remoteFromAddress = remoteFromAddr;
  ...
  public NetworkDelegate(Bagatelle app) {
    this.app = app;
    this.parent = app.getPApplet();
    this.osc = new OscP5(parent, inPort);
    init();
