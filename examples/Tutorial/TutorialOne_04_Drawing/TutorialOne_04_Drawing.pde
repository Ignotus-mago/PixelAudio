 ...
 * Press 'f' to turn "granular" envelope and timing (for drawing) on or off.
...
public void parseKey(char key, int keyCode) {
  ...
  case 'j': // turn audio and image blending on or off
    ...
    break;
  case 'f': // turn "granular" envelope and timing (for drawing) on or off
