 ...
 *
 * In PixelAudio, I call a subclass of PixelMapGen a "gen" object, for short. 
 * Gen objects plug in to PixelAudioMapper. PixelAudioMapper handles mapping back
 * and forth between audio and images and can transcode audio and image data. It
 * has methods for handling arrays of audio samples and RGB pixels and working
 * with the RGB and HSB color spaces.
 *
...
// LAYOUT
int drawingScale = 1;      // scaling of drawing == imageWidth / gen.getWidth()
...
public void initGens() {
  ...
  // get a diagonal zigzag generator and flip the x-coordinates
  // (same as reflecting it on the y-axis)
