...
public class DiagonalZigzagGen extends PixelMapGen {
	 ...
	 */
	public final static String description = "DiagonalZigzagGen generates a continuous diagonal zigzag path starting at (0,0) and (0,1), then going diagonally from edge to edge. "
	...
	/**
	 * Enforces a width and height greater than or equal to 2.
