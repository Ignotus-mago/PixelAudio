 ...
 * curve = 1.0   linear
 * curve > 1.0   slow start, accelerating into target
 * Release:
 * curve < 1.0   drops quickly at first, then tails off slowly
 ...
 * 
 */
 public class EnvelopeShaping extends PApplet {
	...
	public static void main(String[] args) {
		PApplet.main(new String[] { EnvelopeShaping.class.getName() });
	}
	...
	public void initAudio() {
		...
		// set the output sampleRate to either 44100 or 48000, standards for digital 
		// audio recordings.
