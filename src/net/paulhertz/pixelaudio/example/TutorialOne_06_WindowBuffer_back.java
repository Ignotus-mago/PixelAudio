 ...
 *   -- Pixel-shifting animation and transcoding of image and audio data use mapImage.pixels, 
 *      audioSignal, and playBuffer.
...
public class TutorialOne_06_WindowBuffer_back extends PApplet {
	...
	public static void main(String[] args) {
		PApplet.main(new String[] { TutorialOne_06_WindowBuffer_back.class.getName() });
	}
