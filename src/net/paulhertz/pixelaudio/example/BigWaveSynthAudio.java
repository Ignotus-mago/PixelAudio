 ...
 * On startup, we call initWaveDataList() to create a WaveData array with two operators.</p> 
 * 
 * <p>Note the role that sampleRate plays in generating images and audio signals from a 
 ...
 * playback frequency of the PASamplerInstrument:</p>
 * <pre>
 ...
 * </pre>
 * <p>The local sample rate of a WvaeSynth affects the pattern in the display image and may
 ...
 * in symmetrical patterns.</p>
 * 
 * <p>The audio signals and images generated by the WaveSyth data files in the JSON folder
 ...
 * detuning ('t' command) to get a wide range of animation and audio drone effects.</p>
 * 
 * <p>For more information and sample code about the WaveSyth class, see the WaveSynthEditor and 
 * WaveSynthSequencer example sketches.</p>
 * 
 * <pre>
...
public class BigWaveSynthAudio extends PApplet {
	...
	int genWidth = 512;				// width of PixelMapGen objects, for a HilbertGen must be a power of 2
	int genHeight = 512;			// height of PixelMapGen objects, for a HilbertGen must be equal to genWidth
	...
	public static void main(String[] args) {
		PApplet.main(new String[] { BigWaveSynthAudio.class.getName() });
	}
