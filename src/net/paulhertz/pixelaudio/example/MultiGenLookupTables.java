 ...
 * 
 */
public class MultiGenLookupTables extends PApplet {
	...
	public static void main(String[] args) {
		PApplet.main(new String[] { MultiGenLookupTables.class.getName() });
	}
...
/*
 		case 'f':
			...
			break;
		case 'b':
			currentTransform = r90;
			gen.setTransformType(currentTransform);
			updateMapper(gen);
			updateWindow();
			break;
		case '1':
			currentTransform = fx90;
			gen.setTransformType(currentTransform);
			updateMapper(gen);
			updateWindow();
			break;
		case '2':
			currentTransform = fx270;
			gen.setTransformType(currentTransform);
			updateMapper(gen);
			updateWindow();
			break;
